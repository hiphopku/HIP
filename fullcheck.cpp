...
void fullcheckx4(int nevents){


  char* source1 = "run0196_1.dat";
  char* source2 = "run0196_2.dat";
  char* source3 = "ntuple_run0196.csv";
  char* outfile = "run0196_ntuple.root";

  Int_t entries = 0;

  /*
  std::ifstream ifs[3];
  ifs[0].open( "run0200_1.dat" );
  ifs[1].open( "run0200_2.dat" );
  ifs[2].open( "run0200_tof.csv" );
  */
  ...
  while(!ifs1.eof()){
   ...
   tree->Branch("adc_2", dadc_2, "adc[32]/I");
